...
def executaUpdate(msg):
    pwd = msg[4:]
    logging.info('update remoto: ' + pwd)
    call("sudo ansible-pull -U https://mindmakersdisk-school:" + pwd +
         "@github.com/mindmakersdisk/disk.git remote.yml", shell=True)
